...
<body>
                    ...
                    <div class="work-schedule-container">
                        <div class="work-schedule-day" data-day="Monday">
                            <label class="day-label">
                                <input type="checkbox" id="monday" name="work_days" value="Monday" onchange="toggleDayHours('monday')">
                                Monday:
                            </label>
                        ...
                        <div class="work-schedule-day" data-day="Tuesday">
                            <label class="day-label">
                                <input type="checkbox" id="tuesday" name="work_days" value="Tuesday" onchange="toggleDayHours('tuesday')">
                                Tuesday:
                            </label>
                        ...
                        <div class="work-schedule-day" data-day="Wednesday">
                            <label class="day-label">
                                <input type="checkbox" id="wednesday" name="work_days" value="Wednesday" onchange="toggleDayHours('wednesday')">
                                Wednesday:
                            </label>
                        ...
                        <div class="work-schedule-day" data-day="Thursday">
                            <label class="day-label">
                                <input type="checkbox" id="thursday" name="work_days" value="Thursday" onchange="toggleDayHours('thursday')">
                                Thursday:
                            </label>
                        ...
                        <div class="work-schedule-day" data-day="Friday">
                            <label class="day-label">
                                <input type="checkbox" id="friday" name="work_days" value="Friday" onchange="toggleDayHours('friday')">
                                Friday:
                            </label>
    ...
    <script src="/ligonine/admin/doctorRegistry/register.js"></script>
</body>
